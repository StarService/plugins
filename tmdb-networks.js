    ...
    function renderExtraBtn(render, networks, type) {
        ...
        switch (displayMode) {
            ...
            case EXTRA_BTN_DISPLAY_MODE.LIST_BTN: {
                ...
                /* --- Оригінальна іконка "антенка" за побажанням користувача --- */
                btn.html(
                    '<svg version="1.0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="width:1.2em; height:1.2em; vertical-align:middle; margin-right:0.4em;">' +
